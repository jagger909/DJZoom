...
if os.environ.get("DJANGO_SETTINGS_MODULE", None) == "DJZoom.settings":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'test':
        logging.info("Module DJZoom.settings is loading testing settings. Set DJANGO_SETTINGS_MODULE to override this.")
        from .testing import *  # noqa: F401, F403
    else:  # pragma: no cover
        logging.info("Module DJZoom.settings is loading development settings. Set DJANGO_SETTINGS_MODULE to override this.")
